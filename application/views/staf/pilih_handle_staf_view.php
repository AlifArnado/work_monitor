                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                        <div class="content-header">
                            ...
                            <input type="hidden" name="kode_staf_transfer_task" value="<?php echo $kode_staf_transfer_task; ?> ">
                            <input type="hidden" name="kode_staf" value="">
                            <input type="hidden" name="status" value="">
                                <h1>
                                   ...
                                   <br>
                                   <button type="submit" id="simpan" name="task_update" class="btn btn-sm btn-info pull-right" style="margin-top: -10px;"> <span class="hi hi-transfer"></span> Transfer Task</button>
                                </h1>
                            </div>
                        </div>
                        <ul class="breadcrumb breadcrumb-top">
                            <li><a href="<?php echo base_url(); ?>">Projects</a></li>
                            <li><a href="">Pilih Staf</a></li>
                        </ul>
