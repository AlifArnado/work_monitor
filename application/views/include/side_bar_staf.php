   ...
   <div id="sidebar-scroll">
      ...
      <div class="sidebar-content">
         ...
         <ul class="sidebar-nav">
            <li>
               <a href="<?php echo base_url(); ?>"><i class="gi gi-dashboard sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">My Project</span></a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/welcome/create_project"><i class="gi gi-building sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Performance</span></a>
            </li>
         </ul>
