                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-ticket"></i>Create Project Manual Order<br><small>Easily push project to Oranyelab Team!</small>
                                </h1>
                            </div>
                        </div>
                                ...
                                <div class="block">
                                    ...
                                    <form action="<?php echo base_url('index.php/welcome/submit_create_project'); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered" >
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="start-select">Order by:</label>
                                            <div class="col-md-9">
                                                <select name="ae_name" required id="start-select" class="form-control" size="1">
                                                    <option value="null" selected>Pilih AE</option>
                                                    <?php foreach ($data_register as $row): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" required name="deadline" data-date-format="dd/mm/yyyy" id="dp2" class="form-control" placeholder="dd/mm/yyyy" >
