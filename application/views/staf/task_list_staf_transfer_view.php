                     ...
                     <div class="block">
                        ...
                        <div class="block-title">
                           ...
                           <ul class="nav nav-tabs" data-toggle="tabs">
                              <li><a href="#request-list"> <i class="fa fa-bullhorn"></i> Request List</a></li>
                              <li class="active"><a href="#transfer-list"> <i class="hi hi-transfer"></i>  Transfer List</a></li>
                        ...
                        <div class="tab-content">
                           <!-- Request List -->
                           <div class="tab-pane" id="request-list">
                           ...
                           <!-- Transfer List -->
                           <div class="tab-pane active" id="transfer-list">
                              <div class="block-content-full">
                                 <div class="table-responsive remove-margin-bottom">
                                    <table class="table table-striped table-vcenter remove-margin-bottom">
                                       <thead>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo base_url('index.php/staf/dashboard/detail_task/'.$row_data_task->kode_task); ?>"><strong> <?php echo $row_data_task->judul_task; ?> </strong></a><br>
                                             ...
                                             <td class="text-center">
                                                <?php
                                                $data_staf = $this->db->query("SELECT * FROM data_staf WHERE id_staf = '$row_data_task->kode_staf'");
                                                $value_staf = $data_staf->row_array();
                                                echo $value_staf['nama_staf'];
                                                ?>
                                             </td>
